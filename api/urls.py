...
urlpatterns = [
    ...
    path('international-universities/xalqaro',InternationalUniversityListAPIView.as_view()),
    path('international-universities/xususiy',PrivateUniversityListAPIView.as_view()),
